...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getArticleControllerService()
    {
        ...
        $this->services['App\\Controller\\ArticleController'] = $instance = new \App\Controller\ArticleController(($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\ArticleController', $this));
    ...
    protected function getConsultationControllerService()
    {
        ...
        $this->services['App\\Controller\\ConsultationController'] = $instance = new \App\Controller\ConsultationController(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->privates['App\\Repository\\ConsultationRepository'] ?? $this->getConsultationRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\ConsultationController', $this));
    ...
    protected function getImageControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\ImageController', $this));
    ...
    protected function getPermissionControllerService()
    {
        ...
        $this->services['App\\Controller\\PermissionController'] = $instance = new \App\Controller\PermissionController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Repository\\PermissionRepository'] ?? $this->getPermissionRepositoryService()), ($this->privates['App\\Repository\\RoleRepository'] ?? $this->getRoleRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\PermissionController', $this));
    ...
    protected function getPostControllerService()
    {
        ...
        $this->services['App\\Controller\\PostController'] = $instance = new \App\Controller\PostController(($this->privates['App\\Repository\\PostRepository'] ?? $this->getPostRepositoryService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\PostController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\ReactionController' shared autowired service.
     *
     * @return \App\Controller\ReactionController
     */
    protected function getReactionControllerService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ReactionController.php';

        $this->services['App\\Controller\\ReactionController'] = $instance = new \App\Controller\ReactionController(($this->privates['App\\Repository\\ReactionRepository'] ?? $this->getReactionRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\ReactionController', $this));
    ...
    protected function getRoleControllerService()
    {
        ...
        $this->services['App\\Controller\\RoleController'] = $instance = new \App\Controller\RoleController(($this->privates['App\\Repository\\RoleRepository'] ?? $this->getRoleRepositoryService()), ($this->privates['App\\Repository\\PermissionRepository'] ?? $this->getPermissionRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\RoleController', $this));
    ...
    protected function getUsersControllerService()
    {
        ...
        $this->services['App\\Controller\\UsersController'] = $instance = new \App\Controller\UsersController(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->privates['App\\Repository\\RoleRepository'] ?? $this->getRoleRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));

        $instance->setContainer(($this->privates['.service_locator.iRkeTRL'] ?? $this->get_ServiceLocator_IRkeTRLService())->withContext('App\\Controller\\UsersController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Pn7Ka-fxPA', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rl22w9ydaC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ConsultationRepository' => ['privates', 'App\\Repository\\ConsultationRepository', 'getConsultationRepositoryService', false],
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $b), 4 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 6 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 7 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 8 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($a, $b, new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, new \Symfony\Component\Cache\Adapter\ArrayAdapter(0, false), true), NULL, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($a), NULL, ['circular_reference_handler' => new \App\Serializer\CircularReferenceHandler()])], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder()]);
    }
    ...
    /**
     * Gets the private '.service_locator.iRkeTRL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_IRkeTRLService()
    {
        return $this->privates['.service_locator.iRkeTRL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
     ...
     */
    protected function getConsultationRepositoryService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'persistence'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'ObjectRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'collections'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Common'.\DIRECTORY_SEPARATOR.'Collections'.\DIRECTORY_SEPARATOR.'Selectable.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ORM'.\DIRECTORY_SEPARATOR.'EntityRepository.php';
        ...
        return $this->privates['App\\Repository\\ConsultationRepository'] = new \App\Repository\ConsultationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hyAWWjm0D2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'articles_directory' => (\dirname(__DIR__, 4).'/public/articles'),
            'doctors_directory' => (\dirname(__DIR__, 4).'/public/doctors'),
            'users_directory' => (\dirname(__DIR__, 4).'/public/users'),
            'admins_directory' => (\dirname(__DIR__, 4).'/public/admins'),
